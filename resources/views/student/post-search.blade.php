		...
		<div class="col-md-8">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading">
                	<h3 class="panel-title">{{count($searched_posts)}} Posts Found With: "{{ $search_query }}"
                	<a class="btn btn-default return-button"  href="{{ url('student/'.$student->id.'/post') }}">Return</a>
                	</h3>
                	<div class="clear"></div>
              	</div>
