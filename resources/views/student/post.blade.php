	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading">
                	<h3 class="panel-title">{{ ucwords($student->first_name) }} {{ ucwords($student->last_name) }}'s Posts
                	<a class="btn btn-default return-button" href="{{ url('student') }}">Return</a>
                	</h3>
                	<div class="clear"></div>
              	</div>
              		...
              		@foreach($student->posts as $post)
              			<div class="row post">
                            ...
                            @endif
	                           ...
	                           <p class="author"><i class="fa fa-user-o"></i> Author: {{ ucwords($student->first_name) }} {{ ucwords($student->last_name) }}</p>
	                           <br>	
	                          <p>
		...
		<div class="col-md-4">
			...
			<div class="panel panel-default col-xs-12">
	          	<div class="panel-body">
	              	<form method="POST" action="{{ url('student/'.$student->id.'/post/search') }}" id="search-form">
	                {{ csrf_field() }}

		              	<label for="search" class="col-md-12 control-label">Search {{ ucwords($student->first_name) }} {{ ucwords($student->last_name) }}'s Posts</label>
