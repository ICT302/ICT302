                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="password-meter" style="display: none">
                                    ...
                                    <ul>
                                        <li>Use at least 8 characters long or more</li>
                                        <li>Add a lowercase character</li>
                                        <li>Add an uppercase character</li>
                                        <li>Add a number</li>
                                        <li>Add a special character (e.g., ?, %, &)</li>
                                        <li>Avoid common passwords</li>
                                        <li>Avoid something too obvious like your pet’s name</li>
                                    </ul>
                                </div>
